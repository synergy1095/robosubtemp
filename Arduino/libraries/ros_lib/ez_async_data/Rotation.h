#ifndef _ROS_ez_async_data_Rotation_h
#define _ROS_ez_async_data_Rotation_h
...
namespace ez_async_data
{

  class Rotation : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "ez_async_data/Rotation"; };
